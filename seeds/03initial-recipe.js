...
exports.seed = function(knex,Promise) {
  // Deletes ALL existing entries
      ...
      return knex('recipeTable').insert([
        ...
        {name: 'super easy Egg Waffle', cookingtime: '30mins', difficulty: 4.0, admin_id: 1, draft: false , appr_status: false,image_url:'https://img.eservice-hk.net/upload/2020/06/15/162029_89dd9b414a8978212487b77e8549e93c.png'}
      ]);
